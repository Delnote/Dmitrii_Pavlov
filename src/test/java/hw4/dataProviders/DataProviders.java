...
public class DataProviders {
    ...
    public Object[][] testData(){
        ...
        TestDataBuilder testData4 = TestDataBuilder.builder().Odd("5").Even("6").Elements(Arrays.asList(WATER.getName())).Colors(GREEN.getName()).Metals(SELEN.getName()).Vegetables(Arrays.asList(CUCUMBER.getName(), TOMATO.getName(), VEGETABLES.getName(), ONION.getName())).build();
